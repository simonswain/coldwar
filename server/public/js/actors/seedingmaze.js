...
Actors.Seedingmaze = function (env, refs, attrs, opts) {
...
Actors.Seedingmaze.prototype = Object.create(Actor.prototype)

Actors.Seedingmaze.prototype.title = 'Seedingmaze'

Actors.Seedingmaze.prototype.genAttrs = function (attrs) {
  return {
    ttl: 0,
...
Actors.Seedingmaze.prototype.init = function () {
  this.makeGrid();
  this.human = false;
...
Actors.Seedingmaze.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 100,
  max: 1600
...
Actors.Seedingmaze.prototype.makeGrid = function () {
...
Actors.Seedingmaze.prototype.seedActors = function () {
...
Actors.Seedingmaze.prototype.makeGridmates = function () {
...
Actors.Seedingmaze.prototype.connectAllCells = function () {
  var dirs = [[0,-1], [1,0], [0,1], [-1,0]];
  var i, ix, exit;
  var other;
  for (i = 0, ii = this.cells.length; i<ii; i++) {
...
Actors.Seedingmaze.prototype.randomJoins = function (max) {
...
Actors.Seedingmaze.prototype.generatePerfectMaze = function (max) {
  var stack = [];
...
Actors.Seedingmaze.prototype.randomJoin = function () {
...
Actors.Seedingmaze.prototype.randomSplits = function (max) {
...
Actors.Seedingmaze.prototype.randomSplit = function () {
...
Actors.Seedingmaze.prototype.randomBreeders = function (max) {
  if(!max){
    max = 0
  }
  for(var i=0; i<max; i++){
...
Actors.Seedingmaze.prototype.addBreeder = function (ix) {
  this.cells[ix].addBreeder();
}

Actors.Seedingmaze.prototype.addReactor = function (ix) {
  this.cells[ix].addReactor();
}

Actors.Seedingmaze.prototype.randomBreeder = function (max) {
  var x = 5; // attempts
  var ix;
  while (x>0){
...
Actors.Seedingmaze.prototype.randomReactors = function (max) {
  if(!max){
    max = 1
  }
  for(var i=0; i<max; i++){
...
Actors.Seedingmaze.prototype.randomReactor = function (max) {
  var ix = random.from0upto(this.cells.length)
  this.cells[ix].addReactor();
}

Actors.Seedingmaze.prototype.addHuman = function (ix) {
  var human = this.cells[ix].addHuman();
  return human
}

Actors.Seedingmaze.prototype.addPortal = function (ix) {
  var portal = this.cells[ix].addPortal();
  return portal
}

Actors.Seedingmaze.prototype.randomHuman = function (max) {
  var ix = random.from0upto(this.cells.length)
  this.cells[ix].addHuman();
}

Actors.Seedingmaze.prototype.randomHumans = function (max) {
  if(!max){
    max = 1
  }
  for(var i=0; i<max; i++){
...
Actors.Seedingmaze.prototype.route = function (cell, other) {
...
Actors.Seedingmaze.prototype.doGenPhase = function (delta) {
...
Actors.Seedingmaze.prototype.update = function (delta) {
