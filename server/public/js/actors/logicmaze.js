...
Actors.Logicmaze = function (env, refs, attrs, opts) {
...
Actors.Logicmaze.prototype = Object.create(Actor.prototype)

Actors.Logicmaze.prototype.title = 'Logicmaze'

Actors.Logicmaze.prototype.genAttrs = function (attrs) {
  return {
    ttl: 0,
...
Actors.Logicmaze.prototype.init = function () {
  this.makeGrid();
  this.human = false;
...
Actors.Logicmaze.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 100,
  max: 1600
...
Actors.Logicmaze.prototype.makeGrid = function () {
...
Actors.Logicmaze.prototype.seedActors = function () {
...
Actors.Logicmaze.prototype.connectAllCells = function () {
  var dirs = [[0,-1], [1,0], [0,1], [-1,0]];
  var i, ix, exit;
  var other;
  for (i = 0, ii = this.cells.length; i<ii; i++) {
...
Actors.Logicmaze.prototype.randomJoins = function (max) {
...
Actors.Logicmaze.prototype.generatePerfectMaze = function (max) {
  var stack = [];
...
Actors.Logicmaze.prototype.randomJoin = function () {
...
Actors.Logicmaze.prototype.randomSplits = function (max) {
...
Actors.Logicmaze.prototype.randomSplit = function () {
...
Actors.Logicmaze.prototype.randomBreeders = function (max) {
  if(!max){
    max = 0
  }
  for(var i=0; i<max; i++){
...
Actors.Logicmaze.prototype.addBreeder = function (ix) {
  this.cells[ix].addBreeder();
}

Actors.Logicmaze.prototype.addReactor = function (ix) {
  this.cells[ix].addReactor();
}

Actors.Logicmaze.prototype.randomBreeder = function (max) {
  var x = 5; // attempts
  var ix;
  while (x>0){
...
Actors.Logicmaze.prototype.randomReactors = function (max) {
  if(!max){
    max = 1
  }
  for(var i=0; i<max; i++){
...
Actors.Logicmaze.prototype.randomReactor = function (max) {
...
Actors.Logicmaze.prototype.addPortal = function (ix) {
  var portal = this.cells[ix].addPortal();
  return portal
}

Actors.Logicmaze.prototype.randomHuman = function (max) {
  var ix = random.from0upto(this.cells.length)
  this.cells[ix].addHuman();
}

Actors.Logicmaze.prototype.randomHumans = function (max) {
  if(!max){
    max = 1
  }
  for(var i=0; i<max; i++){
...
Actors.Logicmaze.prototype.route = function (cell, other) {
...
Actors.Logicmaze.prototype.doGenPhase = function (delta) {
...
Actors.Logicmaze.prototype.update = function (delta) {
...
Actors.Logicmaze.prototype.paint = function (view, fx) {
