...
Scenes.rat_logic = function (env, opts) {
  this.env = env
...
Scenes.rat_logic.prototype = Object.create(Scene.prototype)
...
Scenes.rat_logic.prototype.getCast = function () {
  return {
    Maze: Actors.Maze,
    Cell: Actors.Cell,
    Human: Actors.Human,
...
Scenes.rat_logic.prototype.defaults = [{
  key: 'max_x',
  info: 'Max X',
  value: 640,
  min: 100,
...
Scenes.rat_logic.prototype.genAttrs = function () {
  return {
  }
}

Scenes.rat_logic.prototype.update = function (delta) {
  this.maze.update(delta);
}


Scenes.rat_logic.prototype.flash = function(fx, gx, sx){
