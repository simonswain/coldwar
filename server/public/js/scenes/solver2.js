...
Scenes.solver2 = function(env, opts){
  this.env = env;
...
Scenes.solver2.prototype = Object.create(Scene.prototype);

Scenes.solver2.prototype.title = 'Solver2';

Scenes.solver2.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver2.prototype.init = function(){
...
Scenes.solver2.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver2.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver2.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver2.prototype.update = function(delta){
}

Scenes.solver2.prototype.paint = function(fx, gx, sx){
