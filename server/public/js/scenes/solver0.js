...
Scenes.solver0 = function (env, opts) {
  this.env = env
...
Scenes.solver0.prototype = Object.create(Scene.prototype)

Scenes.solver0.prototype.title = 'Rat Logic Seec'

Scenes.solver0.prototype.init = function () {
...
Scenes.solver0.prototype.getCast = function () {
  return {
    Maze: Actors.Maze,
    Cell: Actors.Cell,
    Human: Actors.Human,
...
Scenes.solver0.prototype.defaults = [{
  key: 'max_x',
  info: 'Max X',
  value: 640,
  min: 100,
...
Scenes.solver0.prototype.genAttrs = function () {
  return {
  }
}

Scenes.solver0.prototype.update = function (delta) {
...
Scenes.solver0.prototype.flash = function(fx, gx, sx){
...
Scenes.solver0.prototype.paint = function (fx, gx, sx) { 
  gx.ctx.save();
