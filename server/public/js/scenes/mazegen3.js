...
Scenes.mazegen3 = function(env, opts){
  this.env = env;
...
Scenes.mazegen3.prototype = Object.create(Scene.prototype);

Scenes.mazegen3.prototype.title = 'Mazegen3';

Scenes.mazegen3.prototype.genAttrs = function(){
  return {
    ttl: 128,
    rows: 4,
    cols: 4
...
Scenes.mazegen3.prototype.init = function(){
  this.makeGrid();
  this._steps = {
    ttl: this.attrs.ttl,
    cell: -1,
...
Scenes.mazegen3.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.mazegen3.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.mazegen3.prototype.update = function(delta){
}

Scenes.mazegen3.prototype.paint = function(fx, gx, sx){
