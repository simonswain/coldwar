...
Scenes.solver6 = function(env, opts){
  this.env = env;
...
Scenes.solver6.prototype = Object.create(Scene.prototype);

Scenes.solver6.prototype.title = 'Solver6';

Scenes.solver6.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver6.prototype.init = function(){
...
Scenes.solver6.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver6.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver6.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver6.prototype.update = function(delta){
}

Scenes.solver6.prototype.paint = function(fx, gx, sx){
