...
Scenes.weapons = function(env, opts){
  this.env = env;
...
Scenes.weapons.prototype = Object.create(Scene.prototype);

Scenes.weapons.prototype.title = 'Weapons';

Scenes.weapons.prototype.layout = '';

Scenes.weapons.prototype.init = function(){

}

Scenes.weapons.prototype.getCast = function(){
  return {
  }
};

Scenes.weapons.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 32,
  max: 1024
...
Scenes.weapons.prototype.genAttrs = function(){
  return {
    frame_index: 0,
    step_index: 0,
    time: 0,
...
Scenes.weapons.prototype.update = function(delta){
  ...
  if(this.attrs.hold > 0){
    ...
    if (this.attrs.time > this.opts.step_hold) {
      ...
      if (this.attrs.step_index >= Scenes.weapons.prototype.frames[this.attrs.frame_index].text.length) {
...
Scenes.weapons.prototype.frames = [];
