...
Scenes.solver5 = function(env, opts){
  this.env = env;
...
Scenes.solver5.prototype = Object.create(Scene.prototype);

Scenes.solver5.prototype.title = 'Solver5';

Scenes.solver5.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver5.prototype.init = function(){
...
Scenes.solver5.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver5.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver5.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver5.prototype.update = function(delta){
}

Scenes.solver5.prototype.paint = function(fx, gx, sx){
