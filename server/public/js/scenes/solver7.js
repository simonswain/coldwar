...
Scenes.solver7 = function(env, opts){
  this.env = env;
...
Scenes.solver7.prototype = Object.create(Scene.prototype);

Scenes.solver7.prototype.title = 'Solver7';

Scenes.solver7.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver7.prototype.init = function(){
...
Scenes.solver7.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver7.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver7.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver7.prototype.update = function(delta){
}

Scenes.solver7.prototype.paint = function(fx, gx, sx){
  ...
  for(var i = 0, ii=this.attrs.rows * this.attrs.cols; i < ii; i++){
    ...
    if(i === 7){
      ...
      gx.ctx.textBaseline = 'middle';
      gx.ctx.fillStyle = '#fff';
      gx.ctx.fillText('4', (x * ww) + ww/2, (y * hh) + hh*0.5);
    }
    ...
    if(i === 11){
      ...
      gx.ctx.textBaseline = 'middle';
      gx.ctx.fillStyle = '#fff';
      gx.ctx.fillText('5', (x * ww) + ww/2, (y * hh) + hh*0.5);
    }
