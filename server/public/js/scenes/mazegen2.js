...
Scenes.mazegen2 = function(env, opts){
  this.env = env;
...
Scenes.mazegen2.prototype = Object.create(Scene.prototype);

Scenes.mazegen2.prototype.title = 'Mazegen2';

Scenes.mazegen2.prototype.genAttrs = function(){
  return {
    ttl: 128,
    rows: 4,
    cols: 4
...
Scenes.mazegen2.prototype.init = function(){
  this.makeGrid();
  this._steps = {
    ttl: this.attrs.ttl,
    cell: -1,
...
Scenes.mazegen2.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.mazegen2.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.mazegen2.prototype.update = function(delta){
  this._steps.cell = this.cells[6];
}

Scenes.mazegen2.prototype.paint = function(fx, gx, sx){
