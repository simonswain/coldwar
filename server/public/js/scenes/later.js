...
Scenes.later = function(env, opts){
  this.env = env;
...
Scenes.later.prototype = Object.create(Scene.prototype);

Scenes.later.prototype.title = 'Later';

Scenes.later.prototype.layout = '';

Scenes.later.prototype.init = function(){

}

Scenes.later.prototype.getCast = function(){
  return {
  }
};

Scenes.later.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 32,
  max: 1024
...
Scenes.later.prototype.genAttrs = function(){
  return {
    frame_index: 0,
    step_index: 0,
    time: 0,
...
Scenes.later.prototype.update = function(delta){
  ...
  if(this.attrs.hold > 0){
    ...
    if(this.attrs.hold <= 0){
      ...
      if(this.attrs.frame_index === Scenes.later.prototype.frames.length){
    ...
    if (this.attrs.time > this.opts.step_hold) {
      ...
      if (this.attrs.step_index >= Scenes.later.prototype.frames[this.attrs.frame_index].text.length) {
...
Scenes.later.prototype.paint = function(fx, gx, sx){

  var frame = Scenes.later.prototype.frames[this.attrs.frame_index];
