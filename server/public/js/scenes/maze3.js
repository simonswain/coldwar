...
Scenes.maze3 = function (env, opts) {
  this.env = env
...
Scenes.maze3.prototype = Object.create(Scene.prototype)

Scenes.maze3.prototype.title = 'Maze 1'

Scenes.maze3.prototype.init = function () {
...
Scenes.maze3.prototype.defaults = [{
  key: 'max_x',
  info: 'Max X',
  value: 640,
  min: 100,
...
Scenes.maze3.prototype.genAttrs = function () {
  return {
  }
}
...
Scenes.maze3.prototype.flash = function(fx, gx, sx){
