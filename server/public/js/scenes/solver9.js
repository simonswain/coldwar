...
Scenes.solver9 = function(env, opts){
  this.env = env;
...
Scenes.solver9.prototype = Object.create(Scene.prototype);

Scenes.solver9.prototype.title = 'Solver9';

Scenes.solver9.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver9.prototype.init = function(){
  // this.makeGrid();
...
Scenes.solver9.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver9.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver9.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver9.prototype.update = function(delta){
}

Scenes.solver9.prototype.paint = function(fx, gx, sx){
