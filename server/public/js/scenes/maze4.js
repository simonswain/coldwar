...
Scenes.maze4 = function (env, opts) {
  this.env = env
...
Scenes.maze4.prototype.getCast = function () {
  return {
    Maze: Actors.Maze,
    Cell: Actors.Cell,
    Human: Actors.Human,
...
Scenes.maze4.prototype.defaults = [{
  key: 'max_x',
  info: 'Max X',
  value: 640,
  min: 100,
...
Scenes.maze4.prototype.genAttrs = function () {
  return {
  }
}

Scenes.maze4.prototype.update = function (delta) {
...
Scenes.maze4.prototype.flash = function(fx, gx, sx){
...
Scenes.maze4.prototype.paint = function (fx, gx, sx) {
  this.maze.paint(gx)
}
