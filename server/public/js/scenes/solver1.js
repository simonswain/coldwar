...
Scenes.solver1 = function(env, opts){
  this.env = env;
...
Scenes.solver1.prototype = Object.create(Scene.prototype);

Scenes.solver1.prototype.title = 'Solver1';

Scenes.solver1.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver1.prototype.init = function(){
  // this.makeGrid();
...
Scenes.solver1.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver1.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver1.prototype.update = function(delta){
}

Scenes.solver1.prototype.paint = function(fx, gx, sx){
