...
Scenes.training = function(env, opts){
  this.env = env;
...
Scenes.training.prototype = Object.create(Scene.prototype);

Scenes.training.prototype.title = 'Training';

Scenes.training.prototype.layout = '';

Scenes.training.prototype.init = function(){

}

Scenes.training.prototype.getCast = function(){
  return {
  }
};

Scenes.training.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 32,
  max: 1024
...
Scenes.training.prototype.genAttrs = function(){
  return {
    frame_index: 0,
    step_index: 0,
    time: 0,
...
Scenes.training.prototype.update = function(delta){
  ...
  if(this.attrs.hold > 0){
    ...
    //   if(this.attrs.frame_index === Scenes.training.prototype.frames.length){
    ...
    if (this.attrs.time > this.opts.step_hold) {
      ...
      if (this.attrs.step_index >= Scenes.training.prototype.frames[this.attrs.frame_index].text.length) {
...
Scenes.training.prototype.paint = function(fx, gx, sx){

  var frame = Scenes.training.prototype.frames[this.attrs.frame_index];
...
Scenes.training.prototype.frames = [];

Scenes.training.prototype.frames[0] = {
  text:[
    'Training',
  ].join("\n"),
};
