...
Scenes.machines.prototype.frames[0] = {
  text:[
    'We know very little about the machines',
    'except they are hidden deep behind their maze',
    'from where they control our wold',
    'Disable their power source and',
    'you remove their control',
  ].join("\n"),
};
