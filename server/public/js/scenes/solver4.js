...
Scenes.solver4 = function(env, opts){
  this.env = env;
...
Scenes.solver4.prototype = Object.create(Scene.prototype);

Scenes.solver4.prototype.title = 'Solver4';

Scenes.solver4.prototype.genAttrs = function(){
  return {
    rows: this.opts.rows,
    cols: this.opts.cols,
    phase: 'gen'
...
Scenes.solver4.prototype.init = function(){
...
Scenes.solver4.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.solver4.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.solver4.prototype.generatePerfectMaze = function () {
  var stack = [];
...
Scenes.solver4.prototype.update = function(delta){
}

Scenes.solver4.prototype.paint = function(fx, gx, sx){
