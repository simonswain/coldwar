...
Scenes.swarm = function(env, opts){
  this.env = env;
...
Scenes.swarm.prototype = Object.create(Scene.prototype);

Scenes.swarm.prototype.title = 'Swarm';

Scenes.swarm.prototype.layout = '';

Scenes.swarm.prototype.init = function(){

}

Scenes.swarm.prototype.getCast = function(){
  return {
  }
};

Scenes.swarm.prototype.defaults = [{
  key: 'max_x',
  value: 640,
  min: 32,
  max: 1024
...
Scenes.swarm.prototype.genAttrs = function(){
  return {
    frame_index: 0,
    step_index: 0,
    time: 0,
...
Scenes.swarm.prototype.update = function(delta){
  ...
  if(this.attrs.hold > 0){
    ...
    if(this.attrs.hold <= 0){
      ...
      if(this.attrs.frame_index === Scenes.swarm.prototype.frames.length){
    ...
    if (this.attrs.time > this.opts.step_hold) {
      ...
      if (this.attrs.step_index >= Scenes.swarm.prototype.frames[this.attrs.frame_index].text.length) {
...
Scenes.swarm.prototype.paint = function(fx, gx, sx){

  var frame = Scenes.swarm.prototype.frames[this.attrs.frame_index];
...
Scenes.swarm.prototype.frames = [];

Scenes.swarm.prototype.frames[0] = {
  text:[
    'Swarm',
  ].join("\n"),
};
