...
Scenes.mazegen5 = function(env, opts){
  this.env = env;
...
Scenes.mazegen5.prototype = Object.create(Scene.prototype);

Scenes.mazegen5.prototype.title = 'Mazegen5';

Scenes.mazegen5.prototype.genAttrs = function(){
  return {
    ttl: 128,
    rows: 4,
    cols: 4
...
Scenes.mazegen5.prototype.init = function(){
  this.makeGrid();
  this._steps = {
    ttl: this.attrs.ttl,
    cell: -1,
...
Scenes.mazegen5.prototype.defaults = [{
  key: 'max_x',
  value: 480,
  min: 32,
  max: 1024
...
Scenes.mazegen5.prototype.makeGrid = function () {
  // init blank grid
...
Scenes.mazegen5.prototype.update = function(delta){

}

Scenes.mazegen5.prototype.paint = function(fx, gx, sx){
