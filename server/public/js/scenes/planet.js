...
Scenes.planet.prototype.paintData = function (view) {
  ...
  val_x = this.opts.max_x * 0.8
  key_x = this.opts.max_x * 0.82
  y = this.opts.max_x * 0.1
  dy = this.opts.max_x * 0.1

  keys = ['pop', 'agr', 'ind', 'pol']
  ...
  val_x = this.opts.max_x * 0.65
  key_x = this.opts.max_x * 0.65
  y = this.opts.max_x * 0.1
  dy = this.opts.max_x * 0.1

  view.ctx.fillStyle = '#666'

  keys = ['birthrate', 'deathrate', 'agrup', 'indup']
