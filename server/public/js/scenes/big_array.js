...
Scenes.big_array = function (env, opts) {
  this.env = env
...
Scenes.big_array.prototype = Object.create(Scene.prototype)

Scenes.big_array.prototype.title = 'Big Array'

Scenes.big_array.prototype.init = function () {
  this.memory = [];
...
Scenes.big_array.prototype.defaults = [{
  key: 'max_x',
  info: 'Max X',
  value: 480,
  min: 100,
...
Scenes.big_array.prototype.genAttrs = function () {
  return {
  }
}
...
Scenes.big_array.prototype.paint = function (fx, gx, sx) {
